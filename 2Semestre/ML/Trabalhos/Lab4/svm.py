...
def GridSearch(X_train, y_train):
    ...
    C_range = 2. ** numpy.arange(-5, 15, 2)  # busca pelo parâmetro C do SVM RBF
    gamma_range = 2. ** numpy.arange(3, -15, -2)  # busca pelo parâmetro GAMMA do SVM RBF
    k = ['rbf']
    # k = ['linear', 'rbf']
...
def main(datatr, datats):
    ...
    # Treina usando o melhor modelo (Radial Basis Function (RBF) kernel)

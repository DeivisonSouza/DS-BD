...
def pi(inicio, num_passos, passo, Pipe, PROCS):
...
if __name__ == "__main__":                                                                # define "__main__" como método de "__name__"...
    ...
    for i in range(PROCS):                                                                # loop for: inicio do loop sobre o número de processos...
      worker = Process(target=pi, args=(i*proc_size, (i+1)*proc_size - 1, passo, a, i, )) # função process: target recebe a função "pi" e args os parâmetros da função "pi"...
